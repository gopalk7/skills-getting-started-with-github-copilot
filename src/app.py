...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice teamwork and develop basketball skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "liam@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Train for matches and improve soccer techniques",
    ...
    "Art Club": {
        ...
        "max_participants": 20,
        "participants": ["ava@mergington.edu", "sarah@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Math Olympiad": {
        "description": "Challenge your problem-solving skills with advanced math",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["noah@mergington.edu", "lucy@mergington.edu"]
    },
    "Science Club": {
